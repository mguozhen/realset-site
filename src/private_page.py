...
<section class="phero" id="gate" data-h="{pw_hash}" data-k="{slug}" hidden><div class="wrap"><span class="k">Prepared for {html.escape(prepared_for)} · {html.escape(date)}</span><h1>Coding sessions sample pack</h1><p>This page is private. Enter the access code you received to view the samples.</p>
...
<script>{GATE_JS}</script></body></html>'''
    if password:
        (out/'code.sha256').write_text(pw_hash)
        gate = f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Realset — access code</title><meta name="robots" content="noindex,nofollow,noarchive"><link rel="icon" href="/favicon.svg" type="image/svg+xml"><link rel="preconnect" href="https://fonts.googleapis.com"><link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600&display=swap" rel="stylesheet"><link rel="stylesheet" href="/assets/site.css?v={css_hash}"><link rel="stylesheet" href="/assets/private.css?v={css_hash}"></head><body>
<header class="nav solid"><div class="wrap"><nav class="links" aria-label="Primary"><a href="/body/">Body</a><a href="/field/">Field</a><a href="/judge/">Judge</a><a href="/samples/">Samples</a></nav><a class="logo" href="/" aria-label="Realset home">realset<span>.</span></a><div class="navr"><span class="signin">Confidential sample</span></div></div></header>
<section class="phero"><div class="wrap"><span class="k">Prepared for {html.escape(prepared_for)} · {html.escape(date)}</span><h1>{html.escape(title)}</h1><p>This page is private. Enter the access code you received to view the samples.</p>
<form class="gatef" onsubmit="var u=new window.URL(window.location.href);u.searchParams.set('k',this.pw.value.trim());location.href=u.toString();return false;"><input name="pw" type="password" placeholder="Access code" autocomplete="off" required autofocus><button class="btn" type="submit">Open →</button></form><p class="mut" id="ge" hidden style="color:var(--bad)">That code did not match.</p><script>if(new URL(location.href).searchParams.get('k'))document.getElementById('ge').hidden=false;</script></div></section>
<footer><div class="wrap"><div class="fbottom"><div>© 2026 realset.ai · VOC AI INC, San Jose, CA. Confidential sample prepared for {html.escape(prepared_for)}.</div><div class="fmark">realset<span>.</span></div></div></div></footer></body></html>'''
        (out.parent/f'{slug}.gate.html').write_text(gate)
